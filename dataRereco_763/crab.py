...
config.General.requestName = "JetHT_Run2015D_lumiBased_reduced_noJetCoreTracking"
...
config.JobType.psetName   = 'RECO_RAW2DIGI_L1Reco_RECO_ALCA_EI_PAT_DQM_noCoreTracking.py'
