...
# with command line options: step2 --conditions auto:run2_mc --pileup_input das:/RelValMinBias_13/CMSSW_7_4_0_pre7-MCRUN2_74_V7-v1/GEN-SIM -n 10 --eventcontent FEVTDEBUGHLT -s DIGI:pdigi_valid,L1,DIGI2RAW,HLT:@frozen25ns,RAW2DIGI,L1Reco --datatier GEN-SIM-DIGI-RAW-HLTDEBUG --pileup AVE_35_BX_25ns --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1 --magField 38T_PostLS1 --io DIGIUP15_PU25.io --python DIGIUP15_PU25.py --no_exec --filein root://eoscms.cern.ch//store/group/phys_jetmet/schoef/pickEvents/QCD_muProblem/pickevents.root --fileout file:step2.root
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('root://eoscms.cern.ch//store/group/phys_jetmet/schoef/pickEvents/jack_metTailPhys14_susyHadronic/merged_bad_GEN-SIM.root'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/tmp/step2.root'),
