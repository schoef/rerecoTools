...
# with command line options: step3 --conditions auto:run1_data_Fake --scenario pp --process reRECO --data --eventcontent RECO -s RAW2DIGI,RECO --datatier RECO --python RECO.py --conditions 74X_dataRun2_Prompt_v1 -n 10 --no_exec
